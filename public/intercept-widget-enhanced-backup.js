...
(function() {
  ...
  function validateConfig() {
    ...
    if (!isValidHexColor(config.bgColor)) {
      console.warn('[InterceptWidget] Invalid background color, using default');
      config.bgColor = '#ffffff';
    }

    if (!isValidHexColor(config.textColor)) {
      console.warn('[InterceptWidget] Invalid text color, using default');
