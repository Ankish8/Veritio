/**
 * Verification email template — plain, text-forward design.
 * No gradients, no heavy imagery. Just clear communication.
 */
          ...
          <tr>
            <td style="padding:24px 32px 0 32px;">
              ...
              <p style="margin:0 0 24px 0; font-size:15px; line-height:1.6; color:#3f3f46;">
                Please verify your email address to get started with Veritio.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 32px 32px 32px;">
              ...
              <p style="margin:0; font-size:12px; line-height:1.5; color:#a1a1aa;">
                You received this email because an account was created with this address on Veritio. If you didn't sign up, you can safely ignore this email.
              </p>
            </td>
          </tr>
        </table>
