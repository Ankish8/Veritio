 ...
 *
 * Pure URL-generation utilities for Figma prototype embeds.
 * Extracted from the app's figma-client.ts so both apps and packages
 * can generate embed URLs without depending on the full Figma REST API client.
 *
 ...
 * @see https://www.figma.com/developers/embed
 */
export const SCALE_MODE_MAP: Record<PrototypeScaleMode, string> = {
