...
import { PipingReferenceNodeView } from '../study-flow/builder/piping-reference-node-view'
import { RichTextMenuBar } from '../study-flow/builder/rich-text-menu-bar'
...
function CollaborativeEditorInner({
  ...
  // Wait for isStableMount so the Collaboration extension is active,
  ...
  // Detect external store changes (e.g., AI writes, reset to default) and sync to TipTap/Yjs
  useEffect(() => {
