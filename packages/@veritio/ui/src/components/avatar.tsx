...
function AvatarImage({
  ...
  // Use Next.js Image for external URLs (like Supabase storage) to get quality optimization
  // This provides proper srcSet for high-DPI displays and better image quality
  ...
  if (isExternalUrl) {
    return (
      <AvatarPrimitive.Image
        ...
        className={cn(
          "rounded-full aspect-square size-full object-cover relative",
          className
        )}
        src={src}
        alt={alt}
