...
CREATE INDEX IF NOT EXISTS idx_sessions_expires_at ON public.sessions("expiresAt");
CREATE INDEX IF NOT EXISTS idx_accounts_user_id ON public.accounts("userId");
CREATE INDEX IF NOT EXISTS idx_accounts_provider ON public.accounts("providerId", "accountId");
CREATE INDEX IF NOT EXISTS idx_verifications_identifier ON public.verifications(identifier);
CREATE INDEX IF NOT EXISTS idx_verifications_expires_at ON public.verifications("expiresAt");
