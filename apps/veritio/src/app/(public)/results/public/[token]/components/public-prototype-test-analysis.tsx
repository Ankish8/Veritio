...
interface PublicPrototypeTestAnalysisProps {
  tasks: any[]
...
export function PublicPrototypeTestAnalysis({
  tasks: _tasks,
  taskMetrics,
  participants,
}: PublicPrototypeTestAnalysisProps) {
  ...
  return (
    <div className="rounded-lg border bg-card shadow-sm">
      <div className="border-b px-4 py-3 sm:px-6 sm:py-4">
        <h3 className="text-base font-semibold">Task Performance</h3>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b bg-muted/50">
              ...
              <th className="px-4 py-2.5 text-center font-medium text-muted-foreground">Avg. Time</th>
