...
import { signIn, resetSessionRedirectGuard, clearAuthToken } from "@veritio/auth/client"
...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Use hard navigation to ensure cookies are properly sent with the request
      // Next.js router.push() uses client-side navigation which may not include
