...
/**
 * Extended operators for rule conditions
 * Superset of display logic operators with additional comparison types
 */
...
/**
 * A group of conditions (AND/OR logic within group)
 */
...
/**
 * Complete conditions configuration
 * Groups are combined with OR logic (any group matching = conditions met)
 */
...
/**
 * A survey rule defines conditional logic in the survey flow
 */
...
/**
 * Input for creating a new survey rule
 */
...
/**
 * Input for updating a survey rule
 */
...
// -----------------------------------------------------------------------------
// Variable Types (for Score-Based Branching)
// -----------------------------------------------------------------------------

export type VariableType = 'score' | 'classification' | 'counter';

/**
 * Mapping from response value to numeric score
 */
...
/**
 * A question's contribution to a score
 */
...
// -----------------------------------------------------------------------------
// Survey Variable Entity
// -----------------------------------------------------------------------------

/**
 * A survey variable stores calculated values from responses
 */
...
/**
 * Aggregate result of evaluating all rules
 */
...
/**
 * Get the config type for an action
 */
...
/**
 * Get the config type for a trigger
 */
...
/**
 * A single validation issue found in rules
 */
...
/**
 * Result of validating all rules
 */
...
/**
 * A placeholder in a rule template that the user must fill
 */
