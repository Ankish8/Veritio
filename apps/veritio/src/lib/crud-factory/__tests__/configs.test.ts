...
describe("Entity Configurations", () => {
  describe("cardsConfig", () => {
    ...
    it("should generate correct cache key", () => {
      expect(cardsConfig.cache.keyGenerator("study-123")).toBe(
        "cards:study-123",
      );
    });
  ...
  describe("categoriesConfig", () => {
    ...
    it("should generate correct cache key", () => {
      expect(categoriesConfig.cache.keyGenerator("study-123")).toBe(
        "categories:study-123",
      );
    });
  ...
  describe("treeNodesConfig", () => {
    ...
    it("should generate correct cache key", () => {
      expect(treeNodesConfig.cache.keyGenerator("study-123")).toBe(
        "tree-nodes:study-123",
      );
    });
  ...
  describe("tasksConfig", () => {
    ...
    it("should generate correct cache key", () => {
      expect(tasksConfig.cache.keyGenerator("study-123")).toBe(
        "tasks:study-123",
      );
    });
  ...
  describe("Common Configuration Properties", () => {
    ...
    it.each(allConfigs)(
      "should have ownership join in listWithOwnership select",
      (config) => {
