 ...
 * Provides a friendly introduction to the study
 */
 ...
 * Standard consent/agreement for research participation
 */
 ...
 * Controls behavior when participants fail screening questions
 */
 ...
 * Disabled by default - enable when adding demographic or context questions
 */
 ...
 * Provides clear guidance before the main study activity
 */
 ...
 * Disabled by default - enable for feedback collection
 */
 ...
 * This is the main activity section for Survey studies
 */
 ...
 * (Prototype Test, Tree Test, First Click)
 * Defaults to 'one_per_page' for consistent pagination behavior
 */
 ...
 * Shows appreciation after study completion
 */
 ...
 * Shown when a study is no longer accepting responses
 */
 ...
 * Use this as the base when creating new studies
 */
...
// Old card sort defaults — used by the runtime correction to detect stale defaults
