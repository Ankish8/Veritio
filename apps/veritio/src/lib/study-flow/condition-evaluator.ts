 ...
 * Condition Evaluator
 *
 * Evaluates compound conditions for screening and survey branching.
 * Supports checking responses against referenced questions with various operators.
 */
...
/**
 * Extracts the selected option ID(s) from a response value
 */
...
/**
 * Extracts a numeric value from a response (for likert/nps)
 */
...
/**
 * Evaluates a single condition against the responses
 *
 * @param condition - The condition to evaluate
 * @param responses - Map of question ID to response value
 * @param questions - All questions (for type inference)
...
/**
 * Evaluates a condition for numeric responses (likert, nps)
 */
...
/**
 * Evaluates a condition for semantic differential responses
 * Uses the average of all scale values for comparison
 */
...
/**
 * Evaluates a condition for constant sum responses
 * Uses the total allocated points for comparison
 */
...
/**
 * Evaluates a condition for choice responses (radio, dropdown, checkbox)
 */
...
/**
 * Evaluates a condition for text responses
 */
 ...
 * @param matchAll - true for AND logic, false for OR logic
 * @param responses - Map of question ID to response value
 * @param questions - All questions in the same section
 * @returns true if conditions are satisfied according to matchAll logic
 */
...
/**
 * Gets available operators for a given question type
 * Used by the UI to show appropriate operator options
 */
...
/**
 * Operator mapping between ScreeningConditionOperator and AdvancedConditionOperator
 */
...
/**
 * Converts a ScreeningCondition to AdvancedCondition format for survey storage
 */
...
/**
 * Converts an AdvancedCondition to ScreeningCondition format for UI display
 * Returns null if the condition cannot be converted (e.g., variable-based conditions)
 */
...
/**
 * Batch convert ScreeningCondition[] to AdvancedCondition[]
 */
...
/**
 * Batch convert AdvancedCondition[] to ScreeningCondition[]
 * Filters out any conditions that cannot be converted
 */
...
/**
 * Finds all questions that reference a given question ID in their branching conditions.
 * Used to warn users before deleting a referenced question.
 *
 * @param questionIdToCheck - The question ID to search for in conditions
 * @param allQuestions - All questions to search through (same section)
 * @returns Array of question IDs that reference the given question
 */
...
/**
 * Removes all conditions that reference a given question ID from a question's branching logic.
 * Returns the updated question with cleaned conditions.
 *
 * @param question - The question to clean
 * @param referencedQuestionId - The question ID to remove from conditions
 * @returns Updated question with references removed
 */
