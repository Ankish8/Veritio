 ...
 * Survey Rules Engine
 *
 * Core evaluation engine for the Logic Pipeline.
 * Evaluates rule conditions and determines actions based on participant responses.
 */
...
/**
 * Calculate a score variable from responses
 */
...
/**
 * Find a value mapping for a response
 */
...
/**
 * Extract a numeric value from a response
 */
...
/**
 * Calculate a classification variable from other variables
 */
...
/**
 * Calculate a counter variable from responses
 */
...
/**
 * Calculate all variables in dependency order
 */
...
/**
 * Get the value to compare from a condition source
 */
...
/**
 * Evaluate a condition group (conditions combined with AND or OR)
 */
...
/**
 * Evaluate all conditions (groups combined with OR)
 */
...
/**
 * Check if a rule should fire based on its trigger
 */
...
/**
 * Convert rule data to typed action
 */
...
/**
 * Filter rules that should fire based on trigger
 */
...
/**
 * Evaluate all rules and return summary
 *
 * Rules are evaluated in position order.
 * First matching skip/end rule wins.
 * Section visibility rules accumulate.
 * Variable rules accumulate.
 */
...
/**
 * Create a context from player store state
 */
