 ...
 * New code should import directly from '@/stores/segment-store':
 *
 *   // Granular selectors (preferred)
 *   import { useFilteredParticipantIds, useIsFiltering, useSegmentActions } from '@/stores/segment-store'
 *
 *   // Metadata hook
 *   import { useSegmentMetadata } from '@/stores/segment-store'
 *
 *   // Data sync component
 *   import { SegmentDataSync } from '@/stores/segment-store'
 *
...
/**
 * Internal provider that combines store state with metadata
 */
...
/**
 * @deprecated Use individual selectors from '@/stores/segment-store' instead
 *
...
/**
 * Hook to check if a participant ID passes the current filter
 * Returns true if no filtering is active OR if the ID is in the filtered set
 */
...
/**
 * Hook to filter an array of items by participant ID
 * Generic helper for filtering responses, placements, etc.
 */
