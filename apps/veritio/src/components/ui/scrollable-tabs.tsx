...
interface ScrollableTabsListProps
  ...
  /** Show scroll indicators on smaller screens (default: true) */
  showIndicators?: boolean
}

/**
 * A TabsList wrapper that adds horizontal scrolling with gradient indicators.
 * Useful for responsive tab navigation where tabs may overflow on smaller screens.
 *
 * @example
 * <Tabs>
