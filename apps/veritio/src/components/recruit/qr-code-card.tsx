...
export const QRCodeCard = memo(function QRCodeCard({
  ...
  // Use custom color if set, otherwise use primary color from branding
  ...
  useEffect(() => {
    ...
    import('qr-code-styling').then(({ default: QRCodeStyling }) => {
      ...
      if (containerRef.current && mounted) {
        ...
        // Use innerHTML instead of removeChild to avoid React reconciliation conflicts
        containerRef.current.innerHTML = ''
      ...
      // qr-code-styling not installed yet - show placeholder
      if (mounted) {
        setQrLoaded(false)
      }
    })
