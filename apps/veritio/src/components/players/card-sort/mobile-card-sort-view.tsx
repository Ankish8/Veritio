...
export function MobileCardSortView({
  ...
  const assignCard = useCallback(
    (cardId: string, categoryId: string) => {
      if (!canPlaceCard(cardId, categoryId)) {
        onPlacementBlocked(categoryId);
        return;
      }
    ...
    [allCategories, canPlaceCard, cards, onPlacementBlocked, setPlacedCards],
  );
                    ...
                    <span
                      ...
                      style={{
                        backgroundColor:
                          cat.count > 0
                            ? "var(--brand)"
                            : "var(--style-card-border)",
                        color:
                          cat.count > 0
                            ? "var(--brand-foreground, #fff)"
                            : "var(--style-text-muted)",
                      }}
                    >
                      {cat.count}
                  ...
                  >
                    <div className="flex items-center gap-3 p-3">
                      ...
                      >
                        {isSorted ? (
                          ...
                          <span
                            ...
                            style={{
                              backgroundColor: "var(--style-text-muted)",
                            }}
                          />
                        )}
                      </div>
                      ...
                      {category ? (
                        <motion.span
                          initial={
                            justSorted ? { scale: 0.5, opacity: 0 } : false
                          }
          ...
          {categoriesExpanded && (
            ...
            >
              {allCategories.map((cat) => {
                const count = placedCards.filter(
                    ...
                    {isCustom && (
                      <div className="flex gap-1">
                        <Button
                          ...
                          variant="ghost"
                          onClick={() =>
                            handleStartEditCategory(cat.id, cat.label)
                          }
          ...
          <div className="overflow-y-auto flex-1 p-3 space-y-2">
            {allCategories.map((cat) => {
              ...
              const atMaximum =
                cat.max_cards != null &&
                !isCurrentCat &&
                !canPlaceCard(selectedCardId!, cat.id);
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {(settings.showCategoryDescriptions ?? false) &&
                      cat.description && (
                        <p
                          className="text-xs mt-0.5"
                          style={{ color: "var(--style-text-secondary)" }}
                    ...
                    {(cat.min_cards != null || cat.max_cards != null) && (
                      <p
                        className="text-xs mt-0.5"
                        style={{ color: "var(--style-text-secondary)" }}
                      >
              ...
              {sheetNewCategoryMode ? (
                <div className="space-y-3">
                  <Input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" && handleSheetCreateCategory()
                    }
                    autoFocus
                  />
                  <div className="flex gap-2">
