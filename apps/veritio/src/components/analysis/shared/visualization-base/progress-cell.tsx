...
/**
 * Progress bar cell for visualization tables.
 * Provides consistent styling for percentage bars.
 */
...
/**
 * Creates a column definition for a progress bar column.
 * Helper function for building table columns.
 */
