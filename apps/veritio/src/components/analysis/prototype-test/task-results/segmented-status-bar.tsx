...
const SEGMENTS = [
  { key: 'directSuccess', label: 'Direct Success', color: '#16a34a', bgClass: 'bg-green-600', darkText: false },
  { key: 'indirectSuccess', label: 'Indirect Success', color: '#4ade80', bgClass: 'bg-green-400', darkText: true },
  { key: 'failure', label: 'Failure', color: '#ef4444', bgClass: 'bg-red-500', darkText: false },
  { key: 'skipped', label: 'Skipped', color: '#94a3b8', bgClass: 'bg-slate-400', darkText: false },
] as const
