...
/**
 * Get background color class based on metric color
 */
...
/**
 * Mini segmented bar for task row
 */
 ...
 *
 * Displays all tasks side-by-side in a table format for easy comparison.
 * Each cell is color-coded based on metric thresholds (green/amber/red).
 * Clicking a row navigates to the single task view.
 */
