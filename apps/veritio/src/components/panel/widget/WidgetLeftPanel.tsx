...
interface WidgetLeftPanelProps {
  ...
  onIncentiveConfigChange?: (
    updates: Partial<StudyIncentiveConfig>,
...
export function WidgetLeftPanel({
  ...
  const currentTrigger = TRIGGER_OPTIONS.find(
    (t) => t.value === widgetConfig.triggerType,
  );
  const currentStyle =
    WIDGET_STYLES.find(
      (s) => s.value === (widgetConfig.widgetStyle || "popup"),
    ) || WIDGET_STYLES[0];

  return (
    <div className="w-full min-w-0 flex-shrink-0 overflow-x-hidden md:w-[340px] md:min-w-[340px] md:overflow-y-auto">
      <div className="space-y-4 md:pr-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value: WidgetStyle) =>
                onConfigChange({ widgetStyle: value })
              }
            >
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value: WidgetAnimation) =>
                ...
                onValueChange={(value: string) =>
                  onConfigChange(
                    createPositionUpdate(
                      widgetConfig.widgetStyle || "popup",
                      value,
                    ),
                  )
                }
          ...
          {currentTrigger?.unit && (
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  onConfigChange({
                    triggerValue: parseInt(e.target.value) || 5,
                  })
                }
                  ...
                  <TooltipContent side="right" className="max-w-xs p-3">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center gap-3">
                        <code className="font-mono font-semibold bg-white/20 px-2 py-1 rounded">
                          {"{page_title}"}
                        </code>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                placeholder={
                  widgetConfig.copyPersonalization?.variables?.enabled
                    ? "Help us improve {site_name}"
                    : "Take a quick survey and share your feedback."
                }
                rows={3}
        ...
        <div className="space-y-4 border-t pt-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={
                widgetConfig.captureSettings?.collectDemographics ?? false
              }
              onCheckedChange={(checked) =>
                onConfigChange({
                  captureSettings: {
                    ...widgetConfig.captureSettings,
                    collectDemographics: checked,
                  },
                })
              }
            />
          ...
          {widgetConfig.captureSettings?.collectDemographics && (
            <div className="ml-1">
              <WidgetDemographicFieldPicker
                fields={
                  isWidgetDemographicFieldArray(
                    widgetConfig.captureSettings?.demographicFields || [],
                  )
                    ? (widgetConfig.captureSettings
                        ?.demographicFields as WidgetDemographicField[])
          ...
          <div className="space-y-4 border-t pt-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  onIncentiveConfigChange({ enabled: checked })
                }
              />
            </div>
              ...
              <div className="space-y-3 pl-1">
                    ...
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground text-sm">
                        {CURRENCY_OPTIONS.find(
                          (c) =>
                            c.value === (incentiveConfig?.currency || "USD"),
                        )?.symbol || "$"}
                      </span>
                      <Input
                        type="number"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Select
                      ...
                      onValueChange={(value: Currency) =>
                        onIncentiveConfigChange({ currency: value })
                      }
                    >
                      <SelectTrigger className="h-9">
                        <SelectValue />
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    ...
                    onValueChange={(value: IncentiveType) =>
                      onIncentiveConfigChange({ incentive_type: value })
                    }
                  >
                    <SelectTrigger className="h-9">
                      <SelectValue />
                ...
                <div className="rounded-md bg-blue-50 border border-blue-200 p-3 text-sm text-blue-800">
                  When participants complete the study via widget, an incentive
                  record will be created in your Panel.
                </div>
              </div>
            )}
          </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            Paste this code snippet before the closing &lt;/body&gt; tag on your
            website.
          </p>
          <div className="relative">
            <pre className="max-h-32 overflow-y-auto rounded-md bg-muted p-3 pr-24 font-mono text-xs whitespace-pre-wrap break-all md:overflow-x-auto md:whitespace-pre">
