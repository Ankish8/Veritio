...
export const ParticipantsTable = memo(function ParticipantsTable({
    ...
    return (
      <div className="rounded-xl border border-dashed border-border/60 p-12 text-center bg-card/50">
        ...
        <p className="text-sm text-muted-foreground mt-2 max-w-md mx-auto">
          Get started by adding participants manually, importing from CSV, or
          capturing them via your website widget.
        </p>
      </div>
    );
  }
  ...
  return (
    <>
            ...
            >
              <div className="flex items-start gap-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    onSelectId(participant.id, !!checked)
                  }
                ...
                <button
                  ...
                  onFocus={() => onPrefetch?.(participant)}
                >
              ...
              <div className="ml-8 mt-3 flex flex-wrap items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">
                  {participant.study_count ?? 0}{" "}
                  {(participant.study_count ?? 0) === 1 ? "study" : "studies"}
                </span>
              </div>

              <div className="ml-8 mt-3 flex flex-wrap gap-1">
              ...
              <div className="ml-8 mt-3 text-xs text-muted-foreground">
                ...
                {participant.last_active_at
                  ? formatDistanceToNow(new Date(participant.last_active_at), {
                      addSuffix: true,
                    })
                  : "never"}
              </div>
      ...
      <div className="hidden overflow-x-auto rounded-xl bg-card md:block">
