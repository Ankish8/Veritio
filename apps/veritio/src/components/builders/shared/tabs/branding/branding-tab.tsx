...
import { BackgroundSection, LogoSection, ColorSection, StyleSection } from './sections'
import { BrandingPreview } from './preview'

function BrandingTabComponent({ studyId, studyType: _studyType, isReadOnly }: BrandingTabProps) {
