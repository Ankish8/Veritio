...
import { PostTaskQuestionDisplayLogicEditor } from '@/components/builders/shared/post-task-question-display-logic-editor'
...
interface PostTaskQuestionEditorProps {
  ...
  /** Questions that come before this one in the same task (for display logic) */
