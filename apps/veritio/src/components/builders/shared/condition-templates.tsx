...
import type { DisplayLogic } from '@veritio/study-types/study-flow-types'
import {
...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    logic: {
      ...
      matchAll: true, // Both conditions must be met
    },
  },
