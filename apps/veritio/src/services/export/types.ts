...
export interface ExportJob {
  ...
  format: ExportFormat;
  status: ExportStatus;
  options: ExportConfig | Record<string, unknown> | null;
...
export interface TranscriptZipExportConfig {
...
export interface ExportConfig {
  transcript_zip?: TranscriptZipExportConfig;
...
export interface CreateExportRequest {
  ...
  integration: ExportIntegration;
  format: ExportFormat;
  config?: ExportConfig | TranscriptZipExportConfig;
}
