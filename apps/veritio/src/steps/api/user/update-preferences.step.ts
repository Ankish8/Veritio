  ...
  .object({
    profile: z
      .object({
        ...
        displayNamePreference: z
          .enum(["full_name", "first_name", "email"])
          .optional(),
      })
      .optional(),
    studyDefaults: z
      .object({
        branding: z
          .object({
            ...
            stylePreset: z
              .enum(["default", "vega", "nova", "maia", "lyra", "mira"])
              .optional(),
            radiusOption: z
        ...
        settings: z
          .object({
            ...
            closingRuleType: z
              .enum(["none", "date", "participant_count", "both"])
              .optional(),
            maxParticipants: z.number().nullable().optional(),
            responsePreventionLevel: z
              .enum(["none", "relaxed", "moderate", "strict"])
              .optional(),
          })
          .optional(),
        notifications: z
    ...
    workspace: z
      .object({
        ...
        favoritePanelSegmentIds: z.array(z.string().uuid()).max(500).optional(),
      })
      .optional(),
    onboarding: z
      .object({
...
export const handler = async (
  ...
  if (validation.data.profile?.avatarUrl !== undefined) {
    ...
    if (userUpdateError) {
      logger.warn("Failed to sync avatar to user table", {
        userId,
