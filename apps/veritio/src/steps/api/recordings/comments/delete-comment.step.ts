...
import { deleteComment } from '../../../../services/recording/index'

export const config = {
  name: 'DeleteRecordingComment',
  ...
  enqueues: ['recording-comment-deleted'],
...
export const handler = async (req: ApiRequest, { logger, enqueue }: ApiHandlerContext) => {
  ...
  const { success, error } = await deleteComment(supabase, commentId, userId)
  ...
  enqueue({
    topic: 'recording-comment-deleted',
    data: {
