  ...
  persist(
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        // NOTE: currentStep is intentionally NOT persisted. Rehydrating a stale
        // currentStep (e.g. 'activity') after initialize() sets 'welcome' causes
        // the startSession() effect to fire, creating ghost "in progress" participants.
        // Session restoration is handled by useProgressRestoration (survey_progress_* keys).
        currentQuestionIndex: state.currentQuestionIndex,
